...
EVENTS = [
    ("📦 قرارداد تسلیحاتی رسید — ۲ دقیقه فرصت: اولین دکمه‌بزن ۴۰۰ سکه می‌گیرد", "تحویل", 400),
